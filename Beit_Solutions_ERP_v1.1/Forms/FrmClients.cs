...
namespace Beit_Solutions_ERP_v1._1.Forms
{
    public partial class FrmClients : Form
    {
        ...
        public void FillClientForm()
        {
            ...
            txtClientIdSearch.Text = dataGridView1.CurrentRow.Cells[0].Value.ToString();
            comboBoxClientType.Text = dataGridView1.CurrentRow.Cells[1].Value.ToString();
            txtClientNameSearch.Text = dataGridView1.CurrentRow.Cells[2].Value.ToString();
            ...
            try
            {
                dateTimePickerDob.Value = Convert.ToDateTime (dataGridView1.CurrentRow.Cells[7].Value);
                dateTimePickerDob.Text = dateTimePickerDob.Value.ToLongDateString();
            ...
            try
            {
                DateTime Dob = DateTime.Parse(dataGridView1.CurrentRow.Cells[7].Value.ToString());
        ...
        private void ComboBoxClientType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (comboBoxClientType.SelectedIndex == 2)
            {
                //Juristic
                ClientTypeChanged(1);
            }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            Client.ClientSurname = txtClientNameSearch.Text;
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            txtClientIdSearch.Text = string.Empty;
            txtClientName.Text = string.Empty;
            txtClientNameSearch.Text = string.Empty;
        ...
        { 
            ...
            clientObject.ClientNationality = comboBoxNationality.SelectedItem.ToString();
            clientObject.Dob = dateTimePickerDob.Value.ToLongDateString();

            if (callCode == 0)
            {
                if (comboBoxMaritalStatus.SelectedItem == null) { comboBoxMaritalStatus.SelectedIndex = 0; }
                clientObject.ClientSurname = txtClientSurname.Text;
                clientObject.MaritalStatus = comboBoxMaritalStatus.SelectedItem.ToString();
                clientObject.Gender = comboBoxGender.SelectedItem.ToString();
                ...
                clientObject.JuristicType = comboBoxMaritalStatus.SelectedItem.ToString();
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (comboBoxClientType.SelectedItem.ToString().ToLower() == "natural person")
            {
                clientObject = TipifyClient(clientObject, 0);
            }
            else if (comboBoxClientType.SelectedItem.ToString().ToLower() == "juristic person")
            {                
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            Objects.Client clientObject = new Objects.Client();
            DataTable dataTable;
            clientObject.ClientId = txtClientIdSearch.Text;

            if (comboBoxClientType.SelectedItem != null){comboBoxClientType.SelectedIndex = 1;}
